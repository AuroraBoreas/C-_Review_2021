...
class Car:
    ...
    def __repr__(self):
        return f"in {self.__class__}, Name: {self._pet_name}, max_speed: {self._max_speed}, current_speed: {self._current_speed}"
    ...
    def turbo_boost(self): print("Reject turbo boost request")
